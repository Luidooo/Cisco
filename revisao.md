...
> 1. () conectam diferentes redes entre si.
> 2. () protocolo de comunicação em uma rede de computadores
> 3. () conectam vários dispositivos a uma mesma rede.
> 4. () protegem as redes contra acessos não autorizados.
> 5. () Nome dado a um equipamento ligado a rede
...
**Resposta:** Realizar a resolução de nomes, ou seja, traduzir nomes de domínio (ex: www.google.com) em endereços IP (ex: 142.250.218.100).
